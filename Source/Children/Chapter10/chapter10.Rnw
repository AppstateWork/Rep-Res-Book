...
Now let's see how to create this plot with \emph{knitr} and include it in a \LaTeX{} \texttt{figure} environment.\index{LaTeX@\LaTeX{} environment!figure}
